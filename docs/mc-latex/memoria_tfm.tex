...
\begin{document}
 ...
 \include{01_preambulo/contenido_obligatorio/00_portada}
 \include{01_preambulo/contenido_opcional/01_Dedicatoria} % de no haberla comentar esta línea
 \include{01_preambulo/contenido_opcional/02_Acknowledgement} % de no haberlos comentar esta línea
 \include{01_preambulo/contenido_obligatorio/01_Resumen}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \include{02_contenido_principal/01_chap_introducion}
 \include{02_contenido_principal/02_chap_demo}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\include{02_contenido_principal/...}
 \include{02_contenido_principal/03_chap_conclusions}
...
\input{04_terminos/01_acronimos}
\input{04_terminos/02_glosario}
